...
function Clean(){
    ...
    return (
        ...
        <section className='bg-white p-3 sm:p-8 flex flex-row flex-wrap justify-around items-center '>
            <div className=''>
            <h1 className='uppercase text-3xl text-gray-600 font-bold mb-2'>We Move and Clean</h1>
