    ...
    return(
        <section className='bg-white p-6 mx-auto sm:-top-16 -top-12 relative' data-aos="zoom-out">
            <h1 className='text-center font-bold text-3xl my-4 sm:my-10 mb-8' data-aos="fade-right" >GEOGRAPHIC COVERAGE </h1>
                ...
                <p   className='relative md:bottom-80 md:-translate-y-3 lg:bottom-96 md:left-10 lg:left-64 lg:-translate-y-28 bg-white text-black bottom-52 shadow-md sm:px-6 px-2 py-4 sm:w-96 text-sm w-64 sm:text-xl'><span className='font-bold text-sm sm:text-xl -translate-y-1'>LOCAL</span>: Serving the Tri-Cities area and other cities in Tennessee</p>
