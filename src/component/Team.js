...
function Team(){
    ...
    return (
        <div className=''>
            ...
            <h1 className="text-red sm:text-5xl text-3xl font-bold text-center sm:mt-20 mb-3" data-aos="fade-up">OUR TEAM</h1>
            <p className="sm:text-2xl text-sm text-white text-center" data-aos="fade-right">HIGHLY TRAINED PROFESSIONAL IN</p>
