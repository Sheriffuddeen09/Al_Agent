...
function Team(){
    ...
    return (
        <div className=''>
            ...
            <h1 className="text-red text-5xl font-bold text-center my-3">OUR TEAM</h1>
            <p className="text-2xl text-white text-center ">HIGHLY TRAINED PROFESSIONAL IN</p>
